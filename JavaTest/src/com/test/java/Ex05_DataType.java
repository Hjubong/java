...
public class Ex05_DataType {
	...
	public static void main(String[] args) {
		...
		//l1 = 3000000000;
		//최대값은 30억을 넘는데 왜 오류?
		//상수값은 최대 4byte int범위(21억)만 잡기 때문에 오류
		//*** 왜 정수형 상수가 int일까?
		//운영 체제 + CPU
		...
		//단정도형
		float f1;
		//f1 = 3.14; //Type mismatch: cannot convert from double to float
		//뒤에 F를 붙여 해결
		f1 = 3.14F; 
		...
		//배정도형
		double d1;
		d1 = 6.28D; //double은 뒤에 d가 붙기도 생략되기도함
		...
		System.out.println(f1); //1.2345679E29
		...
		//정수형 > 4가지 > int(주력), long(가끔) 을 주로 사용
		//실수형 > 2가지 > double(주력)
		
		//----------------------------------------------------------
		//문자형
		char c1;
		//c1 = A; //A cannot be resolved to a variable
		//해결방법 ''사용 
		c1 = 'A';
