...
public class Ex26_DataTime {
	...
	private static void m6() {
		...
		System.out.println(nowTick); // 1,689,898,940,432ms
		
		long endTick = end.getTimeInMillis();
		System.out.println(endTick); // 1,703,636,712,023ms
	...
	private static void m2() {
		...
		//java.util.GregorianCalendar[time=1689838664618,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id="Asia/Seoul",offset=32400000,dstSavings=0,useDaylight=false,transitions=30,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2023,MONTH=6,WEEK_OF_YEAR=29,WEEK_OF_MONTH=4,DAY_OF_MONTH=20,DAY_OF_YEAR=201,DAY_OF_WEEK=5,DAY_OF_WEEK_IN_MONTH=3,AM_PM=1,HOUR=4,HOUR_OF_DAY=16,MINUTE=37,SECOND=44,MILLISECOND=618,ZONE_OFFSET=32400000,DST_OFFSET=0]
