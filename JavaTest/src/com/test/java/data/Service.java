...
public class Service {
	...
	public static void add() {
		...
		//번호(반)
		String maxStudentNo = Data.list.stream().filter(s -> s.getGradeNo().equals(gradeNo)).filter(s-> s.getClassNo().equals(classNo))
												.map(s-> s.getStudentNO()).max((a,b) -> Integer.parseInt(a) - Integer.parseInt(b)).get();
