...
//		}
	...
	private static void m3() {
		...
		//정규 표현식 객체
		String txt = "안녕하세요. 홍길동 입니다. 제 연락처는 010-1234-5678입니다. 추가 연락처는 011-9876-5432입니다.";
		
		//정규 표현식 객체 생성하기
		//String reget = "[0-9]{3}-[0-9]{3,4}-[0-9]{4}";
		String reget = "(\\d{3})-(\\d{3,4})-(\\d{4})";
		
		//p1 > 정규 표현식 객체
		Pattern p1 = Pattern.compile(reget);
		
		//txt를 대상으로 p1의 패턴을 검색
		Matcher m1 = p1.matcher(txt);
		
		//System.out.println(m1.find()); //검색결과
...
//		System.out.println(m1.find()); //010-1234-56789
...
//		System.out.printf("전화번호가 총 %d회 발견되었습니다.\n", count);
	...
	private static void m1() {
		...
		String txt = "안녕하세요. 홍길동 입니다. 제 연락처는 010-1234-5678입니다. 제 메일은 hong@gmail.com입니다. 추가 연락처는 010-9876-5432입니다.";
