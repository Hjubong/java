...
public class Ex60_List {
	...
	public static void main(String[] args) {
		...
		/*
		 * 컬렉션, Collection - JCF, Java Colllction Framework - (향상된) 배열 - 기존의 순수 배열 - 사용법
		 * 개량 - 용도에 따른 입출력 방식/효율성 개량 - 클래스 + 내부 순수 배열 가지고 있다 - 길이 가변 > 방의 개수를 마음대로 늘리고
		 * 줄이는게 가능 - 자료 구조
		 * 
		 * 
		 * 컬렉션의 종류 1. List 계열 - ArrayList(*****) - LinkedList - Queue - Stack -
		 * Vector(legacy)
		 * 
		 ...
		 * 
		 * 
		 * ArrayList 클래스 - ArrayList(C) -> List(I) -> Collection(I) - 순수배열과 구조가 가장 유사함 -
	...
	private static void m5() {
		...
		//3. ??? 길이가 가변 > 데이터를 계쏙 넣으면 .. 계속 공간이 늘어난다
...
//		System.out.println(list.size());
	...
	private static void m2() {
		...
		list.remove(2);
		// list.remove("포도"); //** 포도가 2개 이상이면 첫번째 포도를 삭제
		...
		//- *** 시프트가 발생 > 삽입된 방 이후의 모든 요소의 방번호 + 1
