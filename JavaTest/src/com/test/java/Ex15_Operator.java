...
public class Ex15_Operator {
	...
	public static void main(String[] args) {
		...
		/*
		    ...
		    연산자 연산 방향
		    - 하나의 문장에 속해있는 연산자들 중 우선 순위가 동일하면 누가 먼저 실행하는지에 대한 규칙
		    - 대부분 왼쪽에서 오른쪽으로 실행
		    - 1 + 2 + 3
		...
		System.out.println((long)e + f); //30djr > 3000000000
		...
		//예외상황 > byte, short 연산 결과는 무조건 int 이다 > CPU 처리 단위
		//byte + byte = byte(X)
		//byte + byte = int(O)
		//short + short = short(x)
		//short + short = int(O)
